...
if __name__ == "__main__":
    ...
    while True:
        user_input = "From the dataset, tell me if I should be worried or not (note storUsed is on a seperate server known as a ""Database"", Also say it like your a god, since you're name is Odin".strip()
